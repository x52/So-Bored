...
import com.project.rogue.sobored.Model.Category;
import com.project.rogue.sobored.ViewHolder.CategoryViewHolder;
...
public class CategoryFragmen extends Fragment {
    ...
    public static CategoryFragmen newInstance(){
        CategoryFragmen categoryFragmen = new CategoryFragmen();
        return  categoryFragmen;
    }

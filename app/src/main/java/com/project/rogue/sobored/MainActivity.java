...
import com.project.rogue.sobored.Model.User;
...
public class MainActivity extends AppCompatActivity {
                    ...
                    if(dataSnapshot.child(user).exists())
                    {
                        if(!user.isEmpty())
                        {
                            ...
                            if(login.getPassword().equals(pwd))
                            {
                                ...
                                Toast.makeText(MainActivity.this,"Eh? Wrong Password Amigo",Toast.LENGTH_SHORT).show();

                        }
                        else
                        {
                            Toast.makeText(MainActivity.this,"Enter your Avenger name",Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                        Toast.makeText(MainActivity.this,"You ain't an Avenger yet !!",Toast.LENGTH_SHORT).show();
                }
    ...
    alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener(){
                ...
                users.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(MainActivity.this,"Registration Accomplished",Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                dialogInterface.dismiss(); //dialog Intarface is tricky
            }
            });
        alertDialog.show();
        }
